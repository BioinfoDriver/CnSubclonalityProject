...
setwd('/pub5/xiaoyun/Jobs/J22/CopyNumberClonalityProject/Results/Section1/Results/Survival/HighPurityMedian')
...
SubcloGenomeSurvPlot(gli.cn.alt.frac, 'IDHwt', 'clo_genome_frac', cutoff.method, 'IDHwt_clo_genome_sur.pdf')
SubcloGenomeSurvPlot(gli.cn.alt.frac, 'IDHmut-non-codel', 'clo_genome_frac', cutoff.method, 'IDHmutNonCodel_clo_genome_sur.pdf')

SubcloGenomeSurvPlot(gli.cn.alt.frac, 'IDHwt', 'non_neutral_genome_frac', cutoff.method, 'IDHwt_alt_burden_sur.pdf')
SubcloGenomeSurvPlot(gli.cn.alt.frac, 'IDHmut-non-codel', 'non_neutral_genome_frac', cutoff.method, 'IDHmutNonCodel_alt_burden_sur.pdf')



# stratified
SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G2', 'G3')), 'IDHwt', 
 'subclo_genome_frac', cutoff.method, 'LGGIDHwt_subclo_genome_sur.pdf')
SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G2', 'G3')), 'IDHmut-non-codel', 
 'subclo_genome_frac', cutoff.method, 'LGGIDHmutNonCodel_subclo_genome_sur.pdf')

SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G2', 'G3')), 'IDHwt', 
 'clo_genome_frac', cutoff.method, 'LGGIDHwt_clo_genome_sur.pdf')
SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G2', 'G3')), 'IDHmut-non-codel', 
 'clo_genome_frac', cutoff.method, 'LGGIDHmutNonCodel_clo_genome_sur.pdf')

SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G2', 'G3')), 'IDHwt', 
 'non_neutral_genome_frac', cutoff.method, 'LGGIDHwt_alt_burden_sur.pdf')
SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G2', 'G3')), 'IDHmut-non-codel', 
 'non_neutral_genome_frac', cutoff.method, 'LGGIDHmutNonCodel_alt_burden_sur.pdf')



SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G4')), 'IDHwt', 
 'subclo_genome_frac', cutoff.method, 'GBMIDHwt_subclo_genome_sur.pdf')
SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G4')), 'IDHmut-non-codel', 
 'subclo_genome_frac', cutoff.method, 'GBMIDHmutNonCodel_subclo_genome_sur.pdf')

SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G4')), 'IDHwt', 
 'clo_genome_frac', cutoff.method, 'GBMIDHwt_clo_genome_sur.pdf')
SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G4')), 'IDHmut-non-codel', 
 'clo_genome_frac', cutoff.method, 'GBMIDHmutNonCodel_clo_genome_sur.pdf')

SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G4')), 'IDHwt', 
 'non_neutral_genome_frac', cutoff.method, 'GBMIDHwt_alt_burden_sur.pdf')
SubcloGenomeSurvPlot(subset(gli.cn.alt.frac, histological_grade %in% c('G4')), 'IDHmut-non-codel', 
 'non_neutral_genome_frac', cutoff.method, 'GBMIDHmutNonCodel_alt_burden_sur.pdf')
